...
function TermsOfService() {
  return (
    <div className="min-h-screen bg-background pb-20">
      <Header title="Terms of Service" backButton />
        ...
        <Card>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              ...
              guarantee uninterrupted access. Service availability may depend on
              third-party providers including InstantDB. We reserve the right to
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">Email: ahmadfathallah89@gmail.com</p>
          </section>
            </div>
          </CardContent>
        </Card>
