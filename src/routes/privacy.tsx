...
function PrivacyPolicy() {
  return (
    <>
      <Header title="Privacy Policy" backButton />
      <div className="bg-white shadow-lg rounded-lg p-8">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              <li>Data is stored using InstantDB's security infrastructure</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              We do not sell, trade, or rent your personal financial information
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              other third-party services. These services have their own privacy
              policies:
            </p>
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              <li>
